	...
	<body class="demo-1 loading">
		<main>
			<div data-scroll class="page page--layout-2">
				<h1 class="page__title">노원구 괴도단</h1>
				<div class="meta">
					<div class="meta__links">
						<a href="https://discord.gg/32ECSF52">입단문의</a>
						<a href="https://discord.gg/ukGHw3bR">디스코드</a>
					</div>
					<div class="meta__demos">
						<a href="/index.jsp" class="meta__demo meta__demo--current">01</a>
						<a href="/com2." class="meta__demo">괴도단 게시판</a>
						<a href="/com3.html" class="meta__demo">괴도단 스레드</a>
						<a href="/com4.html" class="meta__demo">괴도단 채팅방</a>
						<a href="/com5.html" class="meta__demo">괴도단 </a>
				...
				<div class="content content--full content--alternate">
					<div class="content__item content__item--wide">
						...
						<h2 class="content__item-title">NO</h2>
						<p class="content__item-description">Phantom Thieves</p>
					</div>
					<div class="content__item content__item--wide">
						...
						<div class="content__item-deco"></div>
						<h2 class="content__item-title">WON</h2>
						<p class="content__item-description">take yout haert</p>
					</div>
					<div class="content__item content__item--wide">
